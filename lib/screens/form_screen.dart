...
class _FormularioPageState extends State<FormularioPage> {
  ...
  Future<void> _scrollToFirstError() async {
    ...
    if (_servicioSeleccionado == null &&
        _fieldKeys['servicio']?.currentContext != null) {
    ...
    if (_tipoPersona == null &&
        _fieldKeys['tipoPersona']?.currentContext != null) {
      Scrollable.ensureVisible(
    ...
    if (_tipoPersona == 'Nuevo' &&
        _sexo == null &&
        _fieldKeys['sexo']?.currentContext != null) {
      Scrollable.ensureVisible(
    ...
    if (_tipoPersona == 'Nuevo' &&
        _estadoCivil == null &&
        _fieldKeys['estadoCivil']?.currentContext != null) {
      Scrollable.ensureVisible(
    ...
    if (_tipoPersona == 'Nuevo' &&
        _tieneHijos == null &&
        _fieldKeys['tieneHijos']?.currentContext != null) {
      Scrollable.ensureVisible(
